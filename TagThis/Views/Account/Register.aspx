...
<div style="width: 300px; padding:5px 0 10px 0;">
    ...
    <% using (Html.BeginForm()) { %>
					...
					<div class="outerWrap">
					<div class="innerWrap">
					<input type="text" value="" class="textBox" id="userName" name="userName"/>
					</div>
					</div>
					</div>
                   ...
                   <%= Html.ValidationMessage("email", new { style = "display:block; margin-bottom:5px;" })%>
					...
					<div class="outerWrap">
					<div class="innerWrap">
					<input type="password" value="" class="textBox" id="confirmpassword" name="confirmpassword"/>
					</div>
					</div>
					</div>
