...
string g = genre.Replace(" ", "").ToLower();
if(g != "timeline")
{
%>
...
<span class="image">
<img src="../../content/genres/<%= g %>.jpg" class="gimg" width="112" height="112" style="display:none;" onload="$(this).fadeIn(); "/>
</span>
</span>
</a>
<%}
...
<div style="display:block; float:left; width:100%; margin-bottom:50px;">
<a class="bluebutton submitbtn" onclick="$('#submit').click();" style="padding-top: 5px; padding-bottom: 5px; margin-top:20px; display:none;">Next</a>
</div>
