...
%>
    ...
    <ul class="PostHeaderContainer headlinks" style="float:left;">
     ...
     <li  id="invitefriendslink" style="position:relative;"><a href="javascript:void(0)" onclick = "callAppReq();">Invite Friends</a></li>

     <li id="addasonglink" style="position:relative;"><a href="javascript:void(0)" onclick="ModalShow('AddModal');">Add a Song</a></li>
...
<%
    ...
    <div style="right:10px; top:11px; position:absolute;">
