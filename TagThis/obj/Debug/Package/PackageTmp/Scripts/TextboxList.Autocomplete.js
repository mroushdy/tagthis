...
(function () {
    ...
    TextboxList.Autocomplete = function (textboxlist, _options) {
        ...
        var index, prefix, method, container, list, values = [], searchValues = [], results = [],
		placeholder = false, current, currentInput, hidetimer, doAdd, currentSearch, currentRequest;
        ...
        var init = function () {
			...
			.setOptions({ bitsOptions: { editable: { stopEnter: false}} });
        ...
        var search = function (bit) {
            ...
            if (options.queryRemote) {
                if (searchValues[search]) {
                    ...
                    currentRequest = $.ajax({
                        url: options.remote.url,  //why doesn this work
                        data: data,
                        dataType: 'json',
                        success: function (r) {
