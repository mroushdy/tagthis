...
<div class="outerWrap">
<div class="innerWrap">
<input type="text" value="" id="Text" name="Text" title="What do you think?" class="textBox" onkeypress="javascript:(function() {if (window.event.keyCode == 13) {$('#c-sub<%= postid %>').click();}})()"/>
</div>
</div>
</div>
